  ...
  <header class="sticky top-0 bg-weather-primary shadow-lg">
    ...
    >
      ...
      <div class="flex gap-3 flex-1 justify-end">
        <i
          @click="toggleModal"
          class="fa-solid fa-circle-info text-2xl hover:text-weather-secondary duration-150 hover:cursor-pointer"
        />
        <i
          class="fa-solid fa-plus text-2xl hover:text-weather-secondary duration-150 hover:cursor-pointer"
        />
      </div>
      ...
      >
        <div class="text-black">
          ...
          <h2 class="text-2xl">How it work:</h2>
          ...
          <h2 class="text-2xl">Removing the city</h2>
          <p>
